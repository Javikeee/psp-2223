 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.iesvi.org/", wsdlLocation = "http://localhost:1516/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.iesvi.org/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1516/WS/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.iesvi.org/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.iesvi.org/", "CalculadoraImplPort"), Calculadora.class, features);
    }
